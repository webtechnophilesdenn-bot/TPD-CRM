...
class BeforeUpgrade
{
    ...
    protected function processCheckExtensions()
    {
        ...
        if ($extension) {
            ...
            if (version_compare($version, '1.4.2', '<')) {
                $message =
                    "TPDCRM 6.0.0 is not compatible with Google Integration extension of a version lower than 1.4.2. " .
        ...
        if ($extension) {
            ...
            if (version_compare($version, '1.4.0', '<')) {
                $message =
                    "TPDCRM 6.0.0 is not compatible with Real Estate extension of a version lower than 1.4.0. " .
                    "Please upgrade the extension or uninstall it. Then run the upgrade command again.";
        ...
        if ($extension) {
            ...
            if (version_compare($version, '1.15.0', '<')) {
                $message =
                    "TPDCRM 6.0.0 is not compatible with VoIP Integration extension of a version lower than 1.15.0. " .
                    "Please upgrade the extension or uninstall it. Then run the upgrade command again.";
    ...
    protected function processMyIsamCheck()
    {
        ...
        $link = "https://www.TPDCRM.com/blog/converting-myisam-engine-to-innodb";

...
module.exports = grunt => {
    ...
    grunt.initConfig({
        ...
        clean: {
            ...
            final: ['build/tmp'],
            release: ['build/TPDCRM-' + pkg.version],
    ...
    grunt.registerTask('chmod-folders', () => {
        cp.execSync(
            ...
            {cwd: 'build/TPDCRM-' + pkg.version}
        );
    });

    grunt.registerTask('chmod-multiple', () => {
        const dirPath = 'build/TPDCRM-' + pkg.version;
    ...
    grunt.registerTask('zip', function () { // Don't change to arrow-function.
        ...
        const folder = 'TPDCRM-' + pkg.version;
        ...
        zipOutput.on('close', () => {
            console.log("TPDCRM package has been built.");

  ...
  class UpgradeIndexView extends _view.default {
    ...
    data() {
      return {
        ...
        infoMsg: this.translate('upgradeInfo', 'messages', 'Admin').replace('{url}', 'https://www.TPDCRM.com/documentation/administration/upgrading/'),
        ...
        downloadMsg: this.translate('downloadUpgradePackage', 'messages', 'Admin').replace('{url}', 'https://www.TPDCRM.com/download/upgrades')
      };
    }
    afterRender() {

...
import LayoutBottomPanelsDetail from 'views/admin/layouts/bottom-panels-detail';

class LayoutBottomPanelsEdit extends LayoutBottomPanelsDetail {
...
export default LayoutBottomPanelsEdit;

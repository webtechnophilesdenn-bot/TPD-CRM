...
import LinkParentView from 'views/fields/link-parent';

export default class extends LinkParentView {

    setup() {
        this.foreignScopeList = Object.keys(this.getMetadata().get('scopes'))
            .filter(scope => {

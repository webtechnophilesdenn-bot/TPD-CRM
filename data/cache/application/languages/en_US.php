...
Are you sure?'
  ...
  'Admin' => [
    ...
    'messages' => [
      ...
      'upgradeVersion' => 'TPDCRM will be upgraded to version **{version}**. Please be patient as this may take a while.',
      'upgradeDone' => 'TPDCRM has been upgraded to version **{version}**.',
      'upgradeBackup' => 'We recommend making a backup of your TPDCRM files and data before upgrading.',
      ...
      'cronIsNotConfigured' => 'Scheduled jobs are not running.  Hence inbound emails, notifications and reminders are not working. Please follow the [instructions](https://www.TPDCRM.com/documentation/administration/server-configuration/#user-content-setup-a-crontab) to setup cron job.',
      'newVersionIsAvailable' => 'New TPDCRM version {latestVersion} is available. Please follow the [instructions](https://www.TPDCRM.com/documentation/administration/upgrading/) to upgrade your instance.',
      ...
      'upgradeInfo' => 'Check the [documentation]({url}) about how to upgrade your TPDCRM instance.',
    ...
    'descriptions' => [
      ...
      'systemRequirements' => 'System Requirements for TPDCRM.',
...
Field removal does not remove data from the database. Data from the database will be removed if you run hard rebuild.',
  ...
  'Global' => [
    'scopeNames' => [
      ...
      'TargetList' => 'Contact Group',
      'KnowledgeBaseArticle' => 'Knowledge Article',
      'Cemin' => 'CEMIN',
      'Target' => 'Target',
      'Calendar' => 'Calendar',
...
Validation: `{type}`',
    ...
    'dashlets' => [
      ...
      'Opportunities ByStage' => 'Opportunities  by Stage',
      'Opportunities ByLeadSource' => 'Opportunities  by Lead Source',
...
Visit [Google Developers Console](https://console.developers.google.com/project) to obtain OAuth 2.0 credentials such as a Client ID and Client Secret that are known to both Google and TPDCRM application.',
...
`0 0 1 * *` - on the first day of the month'
  ...
  'Settings' => [
    'fields' => [
      ...
      'ldapCreateEspoUser' => 'Create User in TPDCRM',
      ...
      'adminNotificationsNewVersion' => 'Show notification when new TPDCRM version is available',
...
Portals are not affected by restriction.',
      ...
      'siteUrl' => 'A URL of this TPDCRM instance. You need to change it if you move to another domain.',
...
0 - means no expiration.',
      ...
      'ldapUsername' => 'The full system user DN which allows to search other users. E.g. "CN=LDAP System User,OU=users,OU=TPDCRM, DC=test,DC=lan".',
...
- \'Dn\' - the form in the format \'CN=tester,OU=TPDCRM,DC=test, DC=lan\'.
...
- \'Principal\' - the form \'tester@company.com\'.',
      ...
      'ldapBaseDn' => 'The default base DN used for searching users. E.g. "OU=users,OU=TPDCRM,DC=test, DC=lan".',
      ...
      'ldapCreateEspoUser' => 'This option allows TPDCRM to create a user from the LDAP.',
      ...
      'ldapUserLoginFilter' => 'The filter which allows to restrict users who able to use TPDCRM. E.g. "memberOf=CN=espoGroup, OU=groups,OU=TPDCRM, DC=test,DC=lan".',
      ...
      'b2cMode' => 'By default TPDCRM is adapted for B2B. You can switch it to B2C.',
...
**Important**. Changing this role affects all users – review the change carefully to avoid granting unintended permissions.'
  ...
  'User' => [
    ...
    'messages' => [
      ...
      'ldapUserInEspoNotFound' => 'User is not found in TPDCRM. Contact your administrator to create the user.',
...
Leave the field empty if you need to apply the exception only for specific users.',
  ...
  'Contact' => [
    ...
    'links' => [
      ...
      'tasksPrimary' => 'Tasks (expanded)',
      'Opportunities Primary' => 'Opportunities  (Primary)',
      'portalUser' => 'Portal User',
      'originalLead' => 'Original Lead',
      'documents' => 'Documents'
    ],

    ...
    <div class="panel-body">
            ...
            <div class="col-md-12">
                <div style="text-align: center">
                    <div class="content-img margin-bottom">
                        <img class="devices" src="img/start.png" alt="TPDCRM" style="border-radius: var(--border-radius);">
                    </div>
        ...
        <div class="row margin-top">
            ...
            <div class="cell cell-website col-md-4" style="padding-top: 24px; text-align: right;">
                <a
                    target="_blank"
                    href="https://www.TPDCRM.com/documentation/administration/installation/"

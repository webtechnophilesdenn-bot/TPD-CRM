...
class Upgrade implements Command
{
    ...
    public function run(Params $params, IO $io): void
    {
        ...
        if (!$upgradeParams->skipConfirmation) {
            fwrite(STDOUT, "TPDCRM will be upgraded to version $nextVersion now. Enter [Y] to continue.\n");
    ...
    {
        $url = 'https://s.TPDCRM.com/upgrade/next/';
        ...
        if (!$data) {
            echo "Could not Log info about next version.\n";

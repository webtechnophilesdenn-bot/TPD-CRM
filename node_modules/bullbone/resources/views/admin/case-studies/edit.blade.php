...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .current-image img { max-width: 300px; max-height: 200px; border-radius: 6px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); }
...
<body>
        ...
        <form method="POST" action="{{ route('admin.case-studies.update', $caseStudy) }}" enctype="multipart/form-data">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="form-control" required>{{ old('description', $caseStudy->description) }}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="file-upload" onclick="document.getElementById('imageInput').click()">
                            <label class="file-upload-label">
                                ...
                                <small class="form-text">JPG, PNG or WEBP (MAX. 2MB) - Leave empty to keep current image</small>
                            </label>
                            <input type="file" id="imageInput" name="image" accept="image/jpeg,image/png,image/jpg,image/webp" onchange="previewImage(this)">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="search_keywords" class="form-control" value="{{ old('search_keywords', $caseStudy->search_keywords) }}">
                    </div>

                    <div class="form-group">
                        <label class="form-label">Project Date</label>
                        <input type="text" name="project_date" class="form-control" value="{{ old('project_date', $caseStudy->project_date) }}">
                    </div>

                    <div class="form-group">
                        <label class="form-label">Display Order</label>
                        <input type="number" name="display_order" class="form-control" value="{{ old('display_order', $caseStudy->display_order) }}" min="0">
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="categories-grid">
                            @foreach($categories as $category)
                                <label class="category-checkbox {{ in_array($category->id, old('categories', $caseStudy->categories->pluck('id')->toArray())) ? 'checked' : '' }}">
                                    <input type="checkbox" name="categories[]" value="{{ $category->id }}" 
                                           {{ in_array($category->id, old('categories', $caseStudy->categories->pluck('id')->toArray())) ? 'checked' : '' }}
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label class="category-checkbox {{ old('is_featured', $caseStudy->is_featured) ? 'checked' : '' }}">
                            <input type="checkbox" name="is_featured" value="1" {{ old('is_featured', $caseStudy->is_featured) ? 'checked' : '' }}>
                            <span>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <textarea name="challenge" class="form-control">{{ old('challenge', $caseStudy->challenge) }}</textarea>
                    </div>

                    <div class="form-group">
                        <label class="form-label">Solution</label>
                        <textarea name="solution" class="form-control">{{ old('solution', $caseStudy->solution) }}</textarea>
                    </div>

                    <div class="form-group">
                        <label class="form-label">Results</label>
                        <textarea name="results" class="form-control">{{ old('results', $caseStudy->results) }}</textarea>
                    </div>
                </div>
            </div>
                    ...
                    <div class="dynamic-section">
                        ...
                        <div id="technologiesContainer">
                            @foreach($caseStudy->technologies as $index => $tech)
                                <div class="dynamic-item" id="tech-{{ $index }}">
                                    <div class="dynamic-item-header">
                                        <span class="dynamic-item-title">Technology #{{ $index + 1 }}</span>
                                        <button type="button" class="remove-btn" onclick="removeElement('tech-{{ $index }}')">
                                            <i class="fas fa-trash"></i> Remove
                                        </button>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label required">Technology Name</label>
                                        <input type="text" name="technologies[{{ $index }}][name]" class="form-control" value="{{ $tech->name }}" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label required">FontAwesome Icon Class</label>
                                        <input type="text" name="technologies[{{ $index }}][icon]" class="form-control" value="{{ $tech->icon }}" required>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                ...
                <div class="card-body">
                    <div class="dynamic-section">
                        ...
                        <div id="timelineContainer">
                            @foreach($caseStudy->timeline as $index => $item)
                                <div class="dynamic-item" id="timeline-{{ $index }}">
                                    <div class="dynamic-item-header">
                                        <span class="dynamic-item-title">Phase #{{ $index + 1 }}</span>
                                        <button type="button" class="remove-btn" onclick="removeElement('timeline-{{ $index }}')">
                                            <i class="fas fa-trash"></i> Remove
                                        </button>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label required">Date/Phase</label>
                                        <input type="text" name="timeline[{{ $index }}][date]" class="form-control" value="{{ $item->date }}" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label required">Title</label>
                                        <input type="text" name="timeline[{{ $index }}][title]" class="form-control" value="{{ $item->title }}" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label required">Description</label>
                                        <textarea name="timeline[{{ $index }}][description]" class="form-control" required>{{ $item->description }}</textarea>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                    ...
                    <div class="dynamic-section">
                        ...
                        <div id="metricsContainer">
                            @foreach($caseStudy->metrics as $index => $metric)
                                <div class="dynamic-item" id="metric-{{ $index }}">
                                    <div class="dynamic-item-header">
                                        <span class="dynamic-item-title">Metric #{{ $index + 1 }}</span>
                                        <button type="button" class="remove-btn" onclick="removeElement('metric-{{ $index }}')">
                                            <i class="fas fa-trash"></i> Remove
                                        </button>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label required">Number/Value</label>
                                        <input type="text" name="metrics[{{ $index }}][number]" class="form-control" value="{{ $metric->number }}" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label required">Label</label>
                                        <input type="text" name="metrics[{{ $index }}][label]" class="form-control" value="{{ $metric->label }}" required>
                                    </div>
                                </div>
                            @endforeach
                        </div>
    ...
    <script>
        ...
        let techCount = {{ $caseStudy->technologies->count() }};
        function addTechnology() {
            ...
            const html = `
                <div class="dynamic-item" id="tech-${techCount}">
                    ...
                    <div class="form-group">
                        <label class="form-label required">Technology Name</label>
                        <input type="text" name="technologies[${techCount}][name]" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label class="form-label required">FontAwesome Icon Class</label>
                        <input type="text" name="technologies[${techCount}][icon]" class="form-control" required>
                    </div>
                </div>
            `;
        ...
        let timelineCount = {{ $caseStudy->timeline->count() }};
        function addTimeline() {
            ...
            const html = `
                <div class="dynamic-item" id="timeline-${timelineCount}">
                    ...
                    <div class="form-group">
                        <label class="form-label required">Date/Phase</label>
                        <input type="text" name="timeline[${timelineCount}][date]" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label class="form-label required">Title</label>
                        <input type="text" name="timeline[${timelineCount}][title]" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label class="form-label required">Description</label>
                        <textarea name="timeline[${timelineCount}][description]" class="form-control" required></textarea>
                    </div>
                </div>
            `;
            container.insertAdjacentHTML('beforeend', html);
        ...
        let metricCount = {{ $caseStudy->metrics->count() }};
        function addMetric() {
            ...
            const html = `
                <div class="dynamic-item" id="metric-${metricCount}">
                    ...
                    <div class="form-group">
                        <label class="form-label required">Number/Value</label>
                        <input type="text" name="metrics[${metricCount}][number]" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label class="form-label required">Label</label>
                        <input type="text" name="metrics[${metricCount}][label]" class="form-control" required>
                    </div>
                </div>
            `;
            container.insertAdjacentHTML('beforeend', html);

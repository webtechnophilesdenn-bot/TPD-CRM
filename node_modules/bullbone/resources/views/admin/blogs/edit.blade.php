    ...
    <form action="{{ route('admin.blogs.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-row">
            ...
            <div>
                <div class="sidebar-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" name="published_at" id="published_at" class="form-control" value="{{ old('published_at', $blog->published_at?->format('Y-m-d\TH:i')) }}">
                        </div>
                        ...
                        <div class="form-group" style="margin-bottom: 0;">
                            <div class="form-check">
                                <input type="checkbox" name="is_featured" id="is_featured" class="form-check-input" value="1" {{ old('is_featured', $blog->is_featured) ? 'checked' : '' }}>
                ...
                <div class="sidebar-card">
                    <div class="card-header">Category & Tags</div>
                    <div class="card-body">
                        <div class="form-group">
                        ...
                        <div class="form-group" style="margin-bottom: 0;">
                            ...
                            <small class="form-text">Comma-separated values</small>
                        </div>
                    </div>
                </div>

...
class ClientManager
{
    ...
    private string $applicationId = 'TPDCRM';

    private string $nonce;

    private const APP_DESCRIPTION = "TPDCRM – Open Source CRM application.";
    ...
    private function renderInternal(
        ...
        $data = [
            ...
            'apiUrl' => $this->apiUrl,
            'applicationName' => $pageTitle ?? $this->config->get('applicationName', 'TPDCRM'),

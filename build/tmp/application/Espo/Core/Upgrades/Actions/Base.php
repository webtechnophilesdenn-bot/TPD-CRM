...
abstract class Base
{
    ...
    /**
     * Check if version of upgrade/extension is acceptable to current version of TPDCRM.
     *
     * @throws Error
     */
    protected function isAcceptable(): bool
    {
        ...
        if (isset($manifest['acceptableVersions']) && $version !== '@@version') {
            $res &= $this->checkVersions(
                ...
                $version,
                'Your TPDCRM version ({version}) is not supported. Required version: {requiredVersion}.'
            );
        }
